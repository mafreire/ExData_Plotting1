##This script examine how household energy usage varies from the dates 2007-02-01 and 2007-02-02 and constructs plot4
...
##7 - Constructs the plot and saves it as plot4.png file.
plot4  <- function(){
        ...
        ##Create plot4 that is sent to the plot4.png file
        par(mfrow = c(2, 2))
        with(powerC_df, plot(Date_Time, Global_active_power, type="l", 
                             ylab="Global Active Power", xlab=""))
        
        with(powerC_df, plot(Date_Time, Voltage, type="l", 
        ...
        with(powerC_df, plot(Date_Time, Global_reactive_power, type="l", 
                             ylab="Global_reactive_power", xlab="datetime"))
        
        ##Close the png device
        dev.off()
        
        print("Plot created! Please look for the plot4.png file under your current working directory.")
}