##This script examine how household energy usage varies from the dates 2007-02-01 and 2007-02-02 and constructs plot2
...
##7 - Constructs the plot and saves it as plot2.png file.
plot2  <- function(){
        ...
        ##Create plot2 that is sent to the plot2.png file
        ...
        print("Plot created! Please look for the plot2.png file under your current working directory.")
}